...
class Train:
    def __init__(self,root):
        ...
        title_lbl = Label(self.root,text="TRAIN DATA SET", font=("times new roman",36,"bold"),bg="white",fg="red")
        ...
        frame_label.place(x=0,y=55,width=1530,height=325)
        ...
        img_bottom=img_bottom.resize((1530,325),Image.BICUBIC)
        self.photoimg_bottom=ImageTk.PhotoImage(img_bottom)

        frame_label = Label(self.root,image=self.photoimg_bottom)
        frame_label.place(x=0,y=440,width=1530,height=325)
    ...
    def train_classifier(self):
        ...
        clf.train(faces,ids)
        clf.write("classi/classifier.xml")
